...
export class InputFormAssetComponent {
  ...
  post_new_artikel_asset_on_project_artikel() {
    ...
    let newArticle: Article = {
      ...
      preis: preisControl && preisControl.value ? preisControl.value : '',
      ...
      assets: {
        ...
        Inventarnummer: inventarnummerControl && inventarnummerControl.value ? inventarnummerControl.value : 0,
      },
    ...
    let newProjectArticle: ProjectArticle = {
      ...
      menge: mengeControl && mengeControl.value ? mengeControl.value : 0,
      artikel: newArticle
    };
