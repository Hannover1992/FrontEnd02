...
import { DisplayCurrentProjectComponent } from './Components/side-nav_Menu/display-current-project/display-current-project.component';
///
...
@NgModule({
  ...
  declarations: [
    ...
    DisplayCurrentProjectComponent,
  ],
