...
import { ArticleNumbersInputComponent } from './Components/Inputs/Article/create/asset-compose-create/Form/article/details-Input/article-numbers-input/article-numbers-input.component';
import {MatListModule} from "@angular/material/list";
import {MatLegacyChipsModule} from "@angular/material/legacy-chips";
import {MatButtonToggleModule} from "@angular/material/button-toggle";
import { ArticleInputDateComponent } from './Components/Inputs/Article/create/asset-compose-create/Form/article/details-Input/artickle-input-date/article-input-date.component';
import { ArticleInputDetailComponent } from './Components/Inputs/Article/create/asset-compose-create/Form/article/details-Input/article-input-detail/article-input-detail.component';
...
import { ArticleInputComposeComponent } from './Components/Inputs/Article/create/asset-compose-create/Form/article/article-input-compose.component';
...
import { AssetComponent } from './Components/Inputs/Article/create/asset-compose-create/Form/asset/asset.component';
import { ControlComponent } from './Components/Inputs/Article/create/asset-compose-create/control/control.component';
import { MengeComponent } from './Components/Inputs/Article/create/asset-compose-create/Form/menge/menge.component';
